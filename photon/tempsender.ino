// Used Library from https://github.com/kegnet/photon-thermistor/tree/master/firmware
...
void setup() {
  ...
  thermistor = new Thermistor(A0, 9100, 4095, 10000, 25, 3950, 5, 20);
}

void loop() {
  float tempF = thermistor->readTempF();
  Particle.publish(String("save_temp"), String(tempF));
  delay(5000);
}
